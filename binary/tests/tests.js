var oneToTwenty = require('../app/library.js').oneToTwenty;
var twoToForty = require('../app/library.js').twoToForty;
var tenToOneThousand = require('../app/library.js').tenToOneThousand;
var search = require('../app/library.js').search;
